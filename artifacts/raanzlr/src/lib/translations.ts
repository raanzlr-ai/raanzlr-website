...
const ar: typeof en = {
  ...
  about: {
    eyebrow: "عن Raanzlr",
    title: "نبني حلول ذكاء اصطناعي وبرمجيات مصممة للعمل في بيئات الإنتاج، لا للاكتفاء بالعروض التجريبية.",
    sub: "Raanzlr شركة هندسية متخصصة في تطوير حلول الذكاء الاصطناعي، أتمتة الأعمال، ومنصات الويب. نعمل مع الشركات التي تبحث عن أنظمة مستقرة، قابلة للتوسع، وقادرة على تحقيق قيمة حقيقية على المدى الطويل.",
    ...
    values: [
      { title: "تواصل مباشر مع فريق التطوير", desc: "تتواصل مباشرة مع المهندسين المسؤولين عن تصميم وتنفيذ مشروعك، مما يختصر الوقت، يقلل سوء الفهم، ويسرّع اتخاذ القرار." },
      { title: "الجودة جزء من عملية البناء", desc: "نهتم بالاختبارات، التوثيق، مراقبة الأداء، وتجهيز البنية التقنية منذ البداية، لأن نجاح المشروع يبدأ بعد إطلاقه وليس قبله." },
      { title: "نعمل مع فرق حول العالم", desc: "لدينا خبرة في التعاون مع شركات وفرق عمل متعددة الثقافات، مع دعم كامل للعربية والإنجليزية والتركية، وفهم لطبيعة الأسواق المختلفة." },
    ],
    hq: "المقر الرئيسي",
    hqLabel: "// المقر الرئيسي",
    address: "9 Branch Brook Dr #10030, Belleville, NJ 07109",
    hqTitle: "خبرة عالمية... ومقر في قلب مركز التكنولوجيا",
    hqDesc: "يقع مقرنا الرئيسي في ولاية نيوجيرسي، بينما نعمل مع شركات في مختلف دول العالم من خلال نموذج عمل مرن يتيح التعاون بكفاءة أينما كان فريقك.",
    hqImageTagline: "عمليات عالمية • فرق موزعة • تعاون بدون حدود",
  },
  contact: {
    eyebrow: "لنتعاون",
    title: "أخبرنا بما تبنيه.",
    sub: "أرسل ملاحظة سريعة أو موجز مشروع كامل. يراجع أحد مهندسينا كل استفسار، ونرد خلال يوم عمل واحد.",
