        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-5 space-y-2">
              ...
              <div className="flex items-start gap-2 text-xs text-foreground/45">
          ...
          {/* Company */}
          <div>
            <h4 className="text-[10px] font-section-label uppercase text-foreground/40 mb-4">
              {isAr ? "الشركة" : "Company"}
            </h4>
            <ul className="space-y-2.5">
              {LINKS.company.map((l) => (
                <li key={l.href}>
                  <Link to={localizedPath(l.href)} className="text-sm text-foreground/55 hover:text-foreground transition-colors">
                    {isAr ? l.ar : l.en}
                  </Link>
                </li>
              ))}
