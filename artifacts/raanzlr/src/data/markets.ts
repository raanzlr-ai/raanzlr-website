export const MARKET_DETAILS = [
  ...
  // BAHRAIN
  {
    ...
    ar: {
      ...
      metaDescription: "حلول ذكاء اصطناعي وتطوير برمجيات للشركات في البحرين. نساعد المؤسسات على ربط الأنظمة، أتمتة العمليات، وتحسين الكفاءة التشغيلية.",
      keywords: "أتمتة ذكاء اصطناعي البحرين، تطوير برمجيات المنامة، تكامل أنظمة الأعمال البحرين، حلول تقنية للشركات البحرينية",
      heroTitle: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في البحرين",
      heroDescription: "تستفيد الشركات في البحرين من بيئة أعمال مرنة وقطاعات نشطة في الخدمات المالية والتقنية واللوجستيات والتصنيع. ومع توسع الأعمال، تصبح الحاجة إلى أنظمة مترابطة وأتمتة مدروسة أكثر أهمية للحفاظ على سرعة التنفيذ وجودة الخدمة. في Raanzlr نطوّر حلول ذكاء اصطناعي وبرمجيات مخصصة تساعد المؤسسات على تبسيط العمليات، وربط الأنظمة، ومنح فرق العمل أدوات أكثر كفاءة لاتخاذ القرار وإنجاز الأعمال اليومية.",
      whyTitle: "لماذا تتجه الشركات في البحرين نحو الأتمتة؟",
      whyParagraphs: ["تعتمد كثير من المؤسسات على مجموعة من الأنظمة التي أُضيفت تدريجياً مع نمو الأعمال، وهو ما يؤدي مع الوقت إلى تكرار إدخال البيانات، وتعدد مصادر المعلومات، وصعوبة متابعة العمليات بصورة متكاملة.", "لهذا تتجه الشركات إلى حلول تربط ما لديها بدلاً من استبداله بالكامل، وتختصر الإجراءات اليدوية، وتوفر رؤية أوضح لسير العمل.", "نبدأ دائماً بفهم طريقة عمل الفريق، وتدفق البيانات بين الأقسام، ثم نحدد أين يمكن للأتمتة أو البرمجيات المخصصة أن تحقق أكبر أثر عملي بأقل قدر من التعقيد."],
      keyAdvantages: ["حلول تدعم العربية والإنجليزية بصورة طبيعية", "أتمتة مبنية على إجراءات العمل الفعلية", "تكامل مع الأنظمة الحالية دون تعطيلها", "رؤية موحدة للبيانات والعمليات", "تنفيذ تدريجي يقلل المخاطر ويسهّل تبني الحل"],
      servicesTitle: "خدماتنا للشركات في البحرين",
      services: [{ title: "أتمتة سير العمل", description: "أتمتة الإجراءات المتكررة مثل الموافقات، واستقبال الطلبات، وتوجيه المهام، مع الحفاظ على القرارات الحساسة بيد فريق العمل." }, { title: "تطوير البرمجيات المخصصة", description: "تطوير أنظمة داخلية ومنصات تشغيل وبوابات عملاء تتوافق مع احتياجات مؤسستك وآلية عملها." }, { title: "حلول الذكاء الاصطناعي لخدمة العملاء", description: "مساعدون ذكيون بالعربية والإنجليزية للإجابة عن الأسئلة المتكررة، واستقبال الطلبات، وتحويل الحالات التي تحتاج إلى تدخل بشري." }, { title: "لوحات البيانات والتقارير", description: "تجميع البيانات من مصادر مختلفة في لوحة معلومات واحدة تمنح الإدارة رؤية دقيقة ومحدثة للأداء." }, { title: "تكامل الأنظمة", description: "ربط أنظمة إدارة العملاء والأنظمة المالية وأدوات الاتصال والمنصات المختلفة عبر تكاملات موثوقة." }, { title: "تحليل وتحسين العمليات", description: "دراسة الإجراءات الحالية، وتحديد فرص التحسين، ووضع خطة تنفيذ عملية قبل بدء التطوير." }],
  ...
  // OMAN
  {
    ...
    ar: {
      name: "عُمان", region: "دول الخليج", cities: "مسقط • صحار • صلالة • الدقم", metaDescription: "حلول ذكاء اصطناعي وتطوير برمجيات للشركات في عُمان. نساعد المؤسسات على ربط الأنظمة، أتمتة العمليات، وبناء أدوات تدعم الكفاءة التشغيلية.", keywords: "أتمتة ذكاء اصطناعي عُمان، تطوير برمجيات مسقط، تكامل أنظمة عُمان، حلول تقنية للشركات العُمانية",
      heroTitle: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في عُمان", heroDescription: "تشهد المؤسسات في عُمان توسعاً في تبني الحلول الرقمية مع تنوع الأنشطة الاقتصادية وارتفاع الحاجة إلى أنظمة أكثر كفاءة ومرونة. ومع نمو الأعمال، يصبح ربط البيانات وتبسيط الإجراءات عاملاً أساسياً لتحسين الأداء وتسريع اتخاذ القرار. في Raanzlr نطوّر حلول ذكاء اصطناعي وبرمجيات مخصصة تساعد المؤسسات على أتمتة العمليات، وربط الأنظمة، وبناء أدوات تدعم فرق العمل في أداء مهامها اليومية بكفاءة أكبر.",
      whyTitle: "لماذا تتجه المؤسسات في عُمان إلى الأتمتة؟", whyParagraphs: ["تعتمد كثير من المؤسسات على مجموعة من الأنظمة والأدوات التي أُضيفت على مراحل مع توسع الأعمال، وهو ما يؤدي غالباً إلى تكرار إدخال البيانات، وصعوبة متابعة العمليات، وتأخر الوصول إلى المعلومات.", "يساعد ربط هذه الأنظمة وأتمتة الإجراءات المتكررة على تحسين سير العمل، وتقليل الأخطاء، وتوفير صورة أوضح للإدارة والفرق التشغيلية.", "نبدأ دائماً بفهم آلية العمل الحالية، ثم نحدد أين يمكن للتقنية أن تحقق أكبر أثر عملي مع المحافظة على الأنظمة التي ما زالت تؤدي دورها بكفاءة."],
      keyAdvantages: ["حلول تدعم العربية والإنجليزية بصورة طبيعية", "أتمتة مصممة وفق إجراءات العمل الفعلية", "تكامل مع الأنظمة الحالية دون استبدال غير ضروري", "تنفيذ تدريجي يسهّل تبني الحل داخل المؤسسة", "لوحات معلومات تمنح الإدارة رؤية أوضح للأداء"], servicesTitle: "خدماتنا للشركات في عُمان",
