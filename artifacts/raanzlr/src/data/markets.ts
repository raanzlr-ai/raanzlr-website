export const MARKET_DETAILS = [
  // SAUDI ARABIA
  {
    ...
    en: {
      ...
      services: [
        {
          ...
          description: "Automate customer follow-up, reporting, approvals, and data entry. Built for Saudi workflows with Arabic and English support."
        },
        {
          title: "Custom Software Development",
          description: "Internal dashboards, CRM systems, and operational platforms tailored to how your Saudi business actually runs."
        },
        {
          title: "AI Agents for Customer Support",
          description: "Intelligent WhatsApp bots and chatbots that handle inquiries in Arabic and English, 24/7, with human escalation when needed."
        },
        {
          title: "Workflow Automation",
          description: "Connect your tools—CRM, ERP, WhatsApp, emails, spreadsheets—and let workflows run automatically."
        },
        {
          title: "Dashboards & Reporting Systems",
          description: "Real-time visibility into sales, operations, and performance. Built for Saudi leadership teams who need data, not clutter."
        },
        {
          title: "API Integrations",
          description: "Connect local and international platforms—from Mada payments to Salesforce CRM—in one unified system."
        }
      ],
      industriesTitle: "Industries We Serve in Saudi Arabia",
      industries: [
      ...
      whyRaanzlr: [
        "We understand Saudi business culture and decision-making processes",
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "Yes—it's what we specialize in. Our solutions work natively in Arabic (with full RTL support) and English. From AI chatbots to workflow automation, everything is designed for bilingual Saudi workflows."
        },
        {
        ...
        },
        {
          ...
          a: "The first step is a discovery call or an automation audit. We'll walk through your current processes, identify automation opportunities, and provide a clear proposal with timeline and cost. No commitment required for the first conversation."
        },
        {
          q: "Are your solutions compliant with Saudi regulations?",
          a: "Yes. We've worked with clients subject to CITC telecom regulations, SAMA financial rules, and SDAIA's national data governance framework. We design with compliance in mind from day one."
        },
        {
          q: "What's the typical timeline for a project?",
          a: "It depends on scope. A simple chatbot or workflow automation: 2-4 weeks. A custom CRM or dashboard: 6-10 weeks. A full platform with AI features: 12-16 weeks. We always provide a detailed timeline after the discovery phase."
        }
      ],
      ctaTitle: "Ready to Automate Your Business Operations in Saudi Arabia?",
      ctaDescription: "Whether you're in Riyadh, Jeddah, or anywhere across the Kingdom, let's talk about how AI and automation can help your business grow. Book a free consultation with our team."
    },
    ar: {
      name: "المملكة العربية السعودية",
      region: "دول الخليج",
      cities: "الرياض • جدة • الدمام • الخبر • وجميع مدن المملكة",
      metaDescription: "أتمتة الذكاء الاصطناعي وتطوير البرمجيات المخصصة للشركات السعودية. من الرياض إلى جدة، نساعد الشركات على أتمتة العمليات وبناء أنظمة ذكية متوافقة مع رؤية 2030.",
      keywords: "أتمتة الذكاء الاصطناعي السعودية، تطوير برمجيات الرياض، أتمتة الأعمال السعودية، حلول AI الرياض، برمجيات مخصصة جدة، تقنية رؤية 2030",
      heroTitle: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في المملكة العربية السعودية",
      heroDescription: "تساعد Raanzlr الشركات السعودية على تسريع التحول الرقمي من خلال حلول الذكاء الاصطناعي، وأتمتة العمليات، وتطوير البرمجيات المخصصة. نبني أنظمة عملية تتوافق مع طبيعة السوق السعودي، وتتكامل مع أنظمتك الحالية، وتساعد فريقك على العمل بكفاءة أعلى وتحقيق نمو مستدام.",
      whyTitle: "لماذا تتجه الشركات السعودية إلى الذكاء الاصطناعي؟",
      whyParagraphs: [
        "تشهد المملكة العربية السعودية تحولاً رقمياً غير مسبوق مدعوماً برؤية السعودية 2030 والاستثمارات المتسارعة في مختلف القطاعات. ومع توسع الأعمال وارتفاع توقعات العملاء، أصبحت الأتمتة والذكاء الاصطناعي من أهم الأدوات التي تساعد الشركات على تحسين الكفاءة، وتقليل التكاليف، وتسريع النمو.",
        "تعتمد العديد من الشركات اليوم على إجراءات تشغيل يدوية تستهلك الوقت وتحد من الإنتاجية، سواء في إدارة العملاء أو المبيعات أو العمليات الداخلية. وهنا يأتي دور حلولنا، حيث نقوم بتحليل سير العمل الحالي، وتحديد فرص الأتمتة، وبناء أنظمة ذكية تتكامل بسلاسة مع البنية التقنية الموجودة داخل الشركة.",
        "هدفنا ليس استبدال فرق العمل، بل تمكينها من التركيز على المهام الأكثر أهمية من خلال التخلص من الأعمال الروتينية وتحسين جودة اتخاذ القرار."
      ],
      keyAdvantages: [
        "حلول ذكاء اصطناعي تدعم اللغة العربية والإنجليزية بشكل كامل",
      ...
      services: [
        {
          ...
          description: "أتمتة العمليات اليومية مثل إدارة الطلبات، والمتابعات، وإدخال البيانات، وسير العمل الداخلي، مما يساعد الفرق على إنجاز المزيد بوقت أقل."
        },
        {
          title: "تطوير البرمجيات المخصصة",
          description: "تصميم وتطوير أنظمة داخلية، ولوحات تحكم، ومنصات أعمال مصممة خصيصاً بما يتوافق مع احتياجات شركتك وآلية عملها."
        },
        {
          title: "وكلاء الذكاء الاصطناعي لخدمة العملاء",
          description: "إنشاء مساعدين ذكيين يعملون عبر الموقع الإلكتروني أو واتساب أو قنوات التواصل المختلفة للإجابة على استفسارات العملاء على مدار الساعة."
        },
        {
          title: "أتمتة سير العمل",
          description: "ربط الأنظمة المختلفة داخل الشركة وأتمتة انتقال البيانات والمهام بين الإدارات لتقليل التدخل اليدوي وتحسين كفاءة التشغيل."
        },
        {
          title: "لوحات التحكم والتقارير",
          description: "إنشاء لوحات معلومات تفاعلية تعرض مؤشرات الأداء والعمليات والمبيعات بصورة لحظية لمساعدة الإدارة على اتخاذ قرارات مبنية على البيانات."
        },
        {
          title: "تكامل الأنظمة وواجهات API",
          description: "ربط الأنظمة الداخلية والخارجية وتبادل البيانات بينها بطريقة آمنة وفعالة لضمان سير العمل دون انقطاع."
        }
      ],
      industriesTitle: "القطاعات التي نخدمها في المملكة",
      industries: [
        "الرعاية الصحية والمراكز الطبية",
        "اللوجستيات والنقل",
        "العقارات والتطوير العقاري",
        "التجزئة والتجارة الإلكترونية",
        "التعليم والتقنية التعليمية",
        "الخدمات المهنية",
        "الخدمات المالية",
        "الضيافة والسياحة",
        "البناء والهندسة",
        "الحكومة والقطاع العام",
        "الشركات الناشئة وSaaS",
        "التصنيع"
      ],
      useCasesTitle: "كيف تستفيد الشركات السعودية من حلولنا؟",
      useCasesIntro: "إليك كيف تستخدم الشركات السعودية الذكاء الاصطناعي والأتمتة لحل مشاكل حقيقية:",
      useCases: [
        {
          title: "أتمتة خدمة العملاء",
          description: "تطوير وكلاء ذكاء اصطناعي يستقبلون استفسارات العملاء ويردون عليها فوراً عبر الموقع الإلكتروني أو واتساب، مما يسرع الاستجابة ويحسن تجربة العملاء."
        },
        {
          title: "لوحات تحكم للإدارة",
          description: "تجميع البيانات من الأنظمة المختلفة في لوحة تحكم واحدة تعرض مؤشرات الأداء بصورة مباشرة، وتختصر الوقت المستغرق في إعداد التقارير."
        },
        {
          title: "تطوير أنظمة CRM مخصصة",
          description: "تصميم أنظمة إدارة علاقات العملاء بما يتناسب مع دورة المبيعات وإجراءات العمل داخل الشركة بدلاً من الاعتماد على حلول عامة لا تلبي الاحتياجات الفعلية."
        },
        {
          title: "أتمتة إدارة العملاء المحتملين",
          description: "ربط نماذج الموقع الإلكتروني مع أنظمة CRM وأدوات التسويق لتوزيع العملاء المحتملين تلقائياً ومتابعتهم دون تدخل يدوي."
        },
        {
          title: "وكلاء ذكاء اصطناعي للعمليات",
          description: "بناء مساعدين ذكيين يساعدون الموظفين والعملاء في تنفيذ المهام المتكررة والإجابة على الأسئلة وتوفير المعلومات بسرعة ودقة."
        },
        {
          title: "أتمتة العمليات الإدارية",
          description: "أتمتة إنشاء الفواتير، وسير الموافقات، والتقارير الدورية، والإشعارات الداخلية، لتقليل الوقت المستغرق في الأعمال الروتينية وتحسين كفاءة التشغيل."
        }
      ],
      ...
      faqs: [
        {
          ...
          a: "نعم، نقدم خدماتنا للشركات في جميع مدن المملكة، سواء عن بُعد أو من خلال الاجتماعات المباشرة عند الحاجة، مع دعم كامل طوال مراحل المشروع."
        },
        {
          q: "هل تدعم حلولكم اللغة العربية؟",
          a: "بالتأكيد، جميع حلولنا تدعم اللغة العربية والإنجليزية، بما في ذلك واجهات الاستخدام، والأنظمة، ووكلاء الذكاء الاصطناعي، وسير العمل."
        },
        {
          q: "هل يمكن دمج الحلول مع الأنظمة الحالية في شركتنا؟",
          a: "نعم، نحرص على تصميم حلول قابلة للتكامل مع أنظمة ERP وCRM والمنصات الأخرى المستخدمة داخل الشركة لضمان انتقال سلس دون التأثير على العمليات الحالية."
        },
        {
          q: "كيف تبدأ عملية تنفيذ المشروع؟",
          a: "نبدأ بجلسة استكشاف لفهم احتياجات الشركة، ثم نقوم بتحليل العمليات الحالية، وتحديد فرص التحسين، وبعدها نقدم خطة تنفيذ واضحة تشمل المراحل والمدة والتكلفة."
        },
        {
          q: "هل تراعي الحلول المتطلبات التنظيمية داخل المملكة؟",
          a: "نعم، نراعي أفضل الممارسات والمتطلبات التنظيمية ذات العلاقة عند تصميم الحلول، مع التركيز على أمن البيانات، والخصوصية، وقابلية التوسع."
        },
        {
          q: "كم يستغرق تنفيذ المشروع؟",
          a: "تختلف مدة التنفيذ حسب حجم المشروع وتعقيده، ويتم تحديد جدول زمني واضح بعد مرحلة تحليل المتطلبات لضمان تنفيذ المشروع بكفاءة وشفافية."
        }
      ],
      ctaTitle: "ابدأ رحلة التحول الرقمي لشركتك",
      ctaDescription: "سواء كنت تدير شركة ناشئة أو مؤسسة كبيرة في المملكة العربية السعودية، تساعدك Raanzlr على بناء حلول ذكاء اصطناعي وبرمجيات مخصصة ترفع الكفاءة وتسرّع النمو. تواصل معنا اليوم واحصل على استشارة تساعدك في تحديد أفضل الحلول المناسبة لأعمالك."
    }
  },
  ...
  // UAE
  {
    ...
    en: {
      ...
      metaDescription: "AI automation and custom software for UAE businesses. From Dubai to Abu Dhabi, we build intelligent systems for the region's most ambitious companies.",
      keywords: "AI automation UAE, software development Dubai, business automation Abu Dhabi, AI solutions Emirates, custom software UAE, Dubai tech company",
      heroTitle: "AI Automation & Custom Software Development for the UAE",
      heroDescription: "The UAE is a global technology hub—home to ambitious businesses that move at lightning speed. From Dubai's thriving fintech scene to Abu Dhabi's government digitization initiatives, there's an appetite for intelligent automation that few other markets can match. We work with UAE enterprises, startups, and government entities to build AI-powered systems that handle the complexity of a multilingual, multicultural, hyper-connected market.",
      whyTitle: "Why UAE Companies Are Leading in AI Adoption",
      whyParagraphs: [
        "The Emirates didn't become a business hub by accident. The government's AI Strategy 2031 aims to make the UAE the world's most AI-ready nation, and that ambition cascades down to every sector. Companies here understand that operational excellence isn't optional—it's the price of entry.",
        "We see UAE businesses facing unique challenges: multilingual customer bases (Arabic, English, Hindi, Urdu), complex regulatory environments across free zones and mainland jurisdictions, and incredibly high customer expectations shaped by world-class service standards. Manual processes don't scale when you're competing on a global stage.",
        "That's where intelligent automation becomes essential. Whether it's an AI agent handling customer inquiries across three languages simultaneously, a workflow that automates compliance reporting for DIFC or ADGM, or a custom dashboard that gives your leadership team real-time visibility into operations across multiple emirates—technology is what separates fast-moving winners from those struggling to keep up."
      ],
      keyAdvantages: [
      ...
      servicesTitle: "Services Built for UAE Businesses",
      services: [
        {
          title: "AI Automation Solutions",
          description: "Multilingual customer service automation, lead qualification, and workflow orchestration designed for UAE's diverse market."
        },
        {
          title: "Custom Software Development",
          description: "Enterprise platforms, PropTech solutions, and fintech applications built to UAE's exacting standards."
        },
        {
          title: "AI Agents for Customer Support",
          description: "Intelligent chatbots that seamlessly switch between Arabic, English, and Hindi based on customer preference."
        },
        {
          title: "Workflow Automation",
          description: "Connect CRMs, ERPs, payment gateways, and communication tools into unified automated workflows."
        },
        {
          title: "Dashboards & Analytics",
          description: "Real-time executive dashboards with drill-down capabilities across business units and emirates."
        },
        {
          title: "API Integrations",
          description: "Seamless connections between international platforms and UAE-specific systems like Mada, Tabby, and Noon."
        }
      ],
      industriesTitle: "Industries We Serve in the UAE",
      industries: [
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "Yes, we've worked with clients operating under DIFC, ADGM, DED, and various free zone authorities. While we're not legal advisors, we design systems with compliance requirements in mind and work with your legal team to ensure proper implementation."
        },
        {
        ...
        },
        {
          ...
          a: "UAE businesses move fast, and we match that pace. Simple automation: 2-3 weeks. Custom CRM or dashboard: 6-8 weeks. Full platform development: 10-14 weeks. We provide detailed timelines after the discovery phase and build in sprint cycles for continuous feedback."
        },
        {
          q: "How do we get started?",
          a: "Book a free consultation call. We'll discuss your current processes, identify automation opportunities, and provide a clear proposal with scope, timeline, and investment required. First conversation has zero obligation."
        }
      ],
      ctaTitle: "Ready to Build Intelligent Systems for Your UAE Business?",
      ctaDescription: "Whether you're in Dubai, Abu Dhabi, or beyond, let's discuss how AI and automation can give you a competitive edge. Book a free consultation with our team."
    },
    ar: {
      name: "الإمارات العربية المتحدة",
      region: "دول الخليج",
      cities: "دبي • أبوظبي • الشارقة • وجميع إمارات الدولة",
      metaDescription: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في الإمارات العربية المتحدة. نساعد المؤسسات على تسريع التحول الرقمي من خلال حلول ذكية وأتمتة العمليات.",
      keywords: "ذكاء اصطناعي الإمارات، تطوير برمجيات دبي، أتمتة أعمال أبوظبي، حلول AI الإمارات، برمجيات مخصصة الإمارات",
      heroTitle: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في الإمارات العربية المتحدة",
      heroDescription: "تساعد Raanzlr الشركات في الإمارات العربية المتحدة على تسريع التحول الرقمي من خلال حلول ذكاء اصطناعي متقدمة، وأتمتة العمليات، وتطوير البرمجيات المخصصة. نبني أنظمة ذكية تتوافق مع بيئة الأعمال الإماراتية، وتدعم النمو، وترفع الكفاءة التشغيلية، وتمنح المؤسسات القدرة على تقديم تجربة أفضل لعملائها.",
      whyTitle: "لماذا تتبنى الشركات الإماراتية الذكاء الاصطناعي؟",
      whyParagraphs: [
        "تُعد الإمارات من أكثر الأسواق تطوراً في تبني التقنيات الحديثة، حيث تقود مبادرات التحول الرقمي والابتكار في مختلف القطاعات. ومع تسارع الأعمال وارتفاع توقعات العملاء، أصبحت الأتمتة والذكاء الاصطناعي من أهم عوامل تحسين الكفاءة وتعزيز القدرة التنافسية.",
        "تواجه الشركات في الإمارات تحديات متنوعة، مثل إدارة فرق وعملاء من جنسيات متعددة، والتعامل مع أنظمة تشغيل مختلفة، وربط العديد من المنصات والخدمات في بيئة أعمال سريعة التغير. لذلك نعمل على تصميم حلول ذكية تساعد المؤسسات على تبسيط العمليات، وتحسين تجربة العملاء، واتخاذ قرارات مبنية على البيانات.",
        "نركز على بناء حلول عملية وقابلة للتوسع، تتكامل بسهولة مع الأنظمة الحالية، وتمنح الشركات المرونة اللازمة للنمو في سوق يتميز بسرعة التطور."
      ],
      keyAdvantages: [
        "حلول ذكاء اصطناعي تدعم العربية والإنجليزية ولغات متعددة حسب احتياجات المشروع",
        "تطوير برمجيات مخصصة تلائم طبيعة الأعمال في السوق الإماراتي",
        "تكامل مع أنظمة ERP وCRM ومنصات الدفع والخدمات المختلفة",
        "أتمتة العمليات الداخلية وتحسين سرعة الإنجاز ودقة التنفيذ",
        "لوحات تحكم وتقارير تفاعلية تساعد على اتخاذ القرار",
        "حلول قابلة للتوسع مع نمو أعمال الشركة"
      ],
      servicesTitle: "خدماتنا للشركات في الإمارات العربية المتحدة",
      services: [
        {
          title: "حلول أتمتة الذكاء الاصطناعي",
          description: "أتمتة العمليات اليومية، وإدارة الطلبات، والمتابعات، وخدمة العملاء، وسير العمل الداخلي باستخدام حلول ذكاء اصطناعي مصممة لرفع الكفاءة التشغيلية."
        },
        {
          title: "تطوير البرمجيات المخصصة",
          description: "تصميم وتطوير أنظمة أعمال، ولوحات تحكم، ومنصات رقمية مخصصة تتوافق مع احتياجات المؤسسات في مختلف القطاعات."
        },
        {
          title: "وكلاء الذكاء الاصطناعي لخدمة العملاء",
          description: "إنشاء مساعدين ذكيين يعملون عبر الموقع الإلكتروني أو واتساب أو قنوات التواصل المختلفة، مع القدرة على التعامل مع العملاء بلغات متعددة."
        },
        {
          title: "أتمتة سير العمل",
          description: "ربط الأنظمة المختلفة داخل المؤسسة وأتمتة انتقال البيانات والمهام بين الإدارات لتقليل الأعمال اليدوية وتحسين الإنتاجية."
        },
        {
          title: "لوحات التحكم والتحليلات",
          description: "إنشاء لوحات معلومات تفاعلية تعرض مؤشرات الأداء والعمليات بصورة لحظية، وتساعد الإدارة على متابعة الأعمال واتخاذ قرارات دقيقة."
        },
        {
          title: "تكامل الأنظمة وواجهات API",
          description: "ربط الأنظمة الداخلية مع المنصات الخارجية وخدمات الدفع والأدوات المختلفة لضمان تدفق البيانات بكفاءة وسلاسة."
        }
      ],
      industriesTitle: "القطاعات التي نخدمها في الإمارات",
      industries: [
        "الرعاية الصحية والمراكز الطبية",
        "اللوجستيات والنقل",
        "العقارات والتطوير العقاري",
      ...
      useCasesTitle: "كيف تستفيد الشركات الإماراتية من حلولنا؟",
      useCasesIntro: "",
      useCases: [
        {
          title: "01 أتمتة إدارة العملاء المحتملين",
          description: "تطوير أنظمة ذكية تستقبل استفسارات العملاء عبر مختلف القنوات، وتصنفها، وتوجهها إلى الفريق المناسب، مما يسرع الاستجابة ويحسن فرص التحويل."
        },
        {
          title: "02 أتمتة العمليات التنظيمية",
          description: "تبسيط العمليات الداخلية وإعداد التقارير وسير الموافقات من خلال أنظمة ذكية تقلل الوقت المستغرق في الأعمال الروتينية."
        },
        {
          title: "03 إدارة عمليات التجارة الإلكترونية",
          description: "ربط الطلبات والمخزون والشحن والمدفوعات في لوحة تحكم واحدة تساعد فرق العمل على متابعة الأداء واتخاذ قرارات أسرع."
        },
        {
          title: "04 تحسين تجربة العملاء",
          description: "إنشاء مساعدين افتراضيين يقدمون الدعم والإجابة عن الاستفسارات وحجز الخدمات على مدار الساعة عبر مختلف قنوات التواصل."
        },
        {
          title: "05 أتمتة إدارة المواعيد والحجوزات",
          description: "تنظيم المواعيد والزيارات والاجتماعات بصورة تلقائية مع إرسال التذكيرات وتقليل الأعمال الإدارية."
        },
        {
          title: "06 لوحات تحكم للإدارة التنفيذية",
          description: "تجميع بيانات جميع الفروع والإدارات في لوحة تحكم موحدة تعرض مؤشرات الأداء بصورة مباشرة وتساعد الإدارة على متابعة الأعمال بكفاءة."
        }
      ],
      ...
      whyRaanzlr: [
        ...
        "التزام بأفضل معايير الجودة وأمن البيانات",
        "شريك تقني يدعمك في جميع مراحل التطوير والتوسع"
      ],
      faqTitle: "الأسئلة الشائعة",
      faqs: [
        {
          q: "هل تقدمون خدماتكم في جميع إمارات الدولة؟",
          a: "نعم، نقدم خدماتنا للشركات في جميع إمارات الدولة، سواء عن بُعد أو من خلال الاجتماعات المباشرة عند الحاجة، مع دعم مستمر طوال فترة تنفيذ المشروع."
        },
        {
          q: "هل تدعم حلولكم العمل بعدة لغات؟",
          a: "نعم، يمكن تصميم الحلول لتدعم العربية والإنجليزية، بالإضافة إلى لغات أخرى بحسب احتياجات المشروع وطبيعة العملاء المستهدفين."
        },
        {
          q: "هل يمكن دمج الحلول مع الأنظمة الحالية؟",
          a: "بالتأكيد، نحرص على تطوير حلول تتكامل مع أنظمة ERP وCRM وأدوات التشغيل والمنصات المختلفة المستخدمة داخل المؤسسة."
        },
        {
          q: "كيف تبدأون تنفيذ المشروع؟",
          a: "نبدأ بجلسة استشارية لفهم أهداف الشركة وتحليل العمليات الحالية، ثم نضع خطة تنفيذ واضحة تتضمن مراحل المشروع والمدة الزمنية والتكلفة المتوقعة."
        },
        {
          q: "هل تراعي الحلول المتطلبات التنظيمية داخل الإمارات؟",
          a: "نعم، نراعي أفضل الممارسات والمتطلبات التنظيمية ذات العلاقة عند تصميم الحلول، مع التركيز على حماية البيانات، وأمن المعلومات، وقابلية التوسع."
        },
        {
          q: "كم تستغرق مشاريع التطوير عادة؟",
          a: "تعتمد مدة التنفيذ على حجم المشروع ومتطلباته، ويتم تحديد جدول زمني واضح بعد دراسة الاحتياجات لضمان تنفيذ المشروع بكفاءة وجودة عالية."
        }
      ],
      ctaTitle: "ابدأ رحلة التحول الرقمي لشركتك في الإمارات",
      ctaDescription: "سواء كنت تدير شركة ناشئة أو مؤسسة رائدة في الإمارات العربية المتحدة، تساعدك Raanzlr على تطوير حلول ذكاء اصطناعي وبرمجيات مخصصة تعزز الكفاءة وتدعم نمو أعمالك. تواصل معنا اليوم لاكتشاف الحل الأنسب لاحتياجات شركتك."
    }
  },
  ...
  // QATAR
  {
    ...
    en: {
      ...
      metaDescription: "AI automation and custom software for Qatar businesses. Building intelligent systems for Doha's rapidly digitizing economy aligned with National Vision 2030.",
      keywords: "AI automation Qatar, software development Doha, business automation Qatar, AI solutions Doha, custom software Qatar, Qatar Vision 2030 technology",
      heroTitle: "AI Automation & Custom Software Development for Qatar",
      heroDescription: "Qatar's National Vision 2030 has positioned the country as a leader in innovation and digital transformation. From the legacy of hosting the World Cup to government-led digitization initiatives, there's a clear momentum toward intelligent business systems. We work with Qatari enterprises, hospitality groups, educational institutions, and government entities to build AI and automation solutions that match the country's ambition for excellence.",
      ...
      keyAdvantages: [
        ...
        "Quality-focused engineering that matches Qatar's standards"
      ],
      servicesTitle: "Services for Qatar's Growing Economy",
      services: [
        {
          title: "AI Automation for Hospitality",
          description: "Guest service automation, multilingual concierge bots, and booking systems for Qatar's world-class hotels and tourism sector."
        },
        {
          title: "Education Technology Solutions",
          description: "Student information systems, learning management platforms, and administrative automation for schools and universities."
        },
        {
          title: "Government Digital Services",
          description: "Citizen service portals, workflow automation, and data management systems for public sector digitization."
        },
        {
          title: "Professional Services Automation",
          description: "Client management, project tracking, and reporting systems for consulting, legal, and accounting firms."
        },
        {
          title: "Custom Business Applications",
          description: "Tailored software for Qatar's unique business needs—from construction management to events coordination."
        },
        {
          title: "AI Agents & Chatbots",
          description: "Intelligent assistants for customer service, internal support, and information delivery in Arabic and English."
        }
      ],
      industriesTitle: "Industries We Serve in Qatar",
      industries: [
        "Hospitality & Tourism",
        "Education & Training",
        "Construction & Engineering",
      ...
      faqs: [
        {
          ...
          a: "Yes, we work with Qatari companies, educational institutions, and government entities. We operate remotely but visit when needed for discovery, presentations, or training. We're available during Doha business hours."
        },
        {
          q: "Can you build systems for both Arabic and English users?",
          a: "Absolutely. All our solutions support Arabic (with proper RTL) and English. We design interfaces and workflows that work naturally in both languages based on user preference."
        },
        {
          q: "Do you understand Qatar's business culture?",
          a: "Yes, we've worked with Qatari organizations and understand the importance of relationships, quality, and thorough decision-making. We adapt our approach to match your organization's culture and pace."
        },
        {
          q: "What's your approach to project timelines in Qatar?",
          a: "We believe in sustainable timelines that deliver quality results. Simple automation: 3-4 weeks. Custom systems: 8-12 weeks. We provide detailed plans and regular updates throughout."
        },
        {
          q: "Can you integrate with our existing systems?",
          a: "Yes, we specialize in integration. Whether you're using international platforms like SAP or Oracle, regional systems, or custom software—we can connect them."
        },
        {
          q: "How do we start?",
          a: "Book a consultation call. We'll learn about your organization, discuss challenges and opportunities, and provide a clear proposal. First conversation is always exploratory with no commitment."
        }
      ],
      ctaTitle: "Ready to Build Intelligent Systems for Your Qatar Organization?",
      ctaDescription: "Whether you're in Doha or across Qatar, let's discuss how AI and automation can enhance your operations while maintaining the quality standards Qatar is known for."
    },
    ar: {
      name: "قطر",
      region: "دول الخليج",
      cities: "الدوحة • الريان • الوكرة • وجميع أنحاء دولة قطر",
      metaDescription: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في قطر. نساعد المؤسسات على تسريع التحول الرقمي من خلال حلول ذكية وأتمتة العمليات.",
      keywords: "ذكاء اصطناعي قطر، تطوير برمجيات الدوحة، أتمتة أعمال قطر، حلول AI قطر، برمجيات مخصصة قطر",
      heroTitle: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في قطر",
      heroDescription: "تساعد Raanzlr الشركات والمؤسسات في قطر على تسريع التحول الرقمي من خلال حلول الذكاء الاصطناعي، وأتمتة العمليات، وتطوير البرمجيات المخصصة. نصمم أنظمة ذكية تدعم الكفاءة التشغيلية، وتحسن تجربة العملاء، وتواكب متطلبات السوق القطري في مختلف القطاعات.",
      whyTitle: "لماذا تتجه المؤسسات في قطر إلى الذكاء الاصطناعي؟",
      whyParagraphs: [
        "تشهد قطر تطوراً متسارعاً في مجال التحول الرقمي، مدفوعاً برؤية قطر الوطنية 2030 والاستثمارات المستمرة في التكنولوجيا والابتكار. وتسعى المؤسسات اليوم إلى رفع كفاءة العمليات، وتحسين جودة الخدمات، والاستفادة من البيانات في اتخاذ القرارات بصورة أكثر دقة.",
        "تواجه الشركات تحديات متزايدة مع توسع الأعمال، وتعدد الأنظمة، وارتفاع توقعات العملاء، مما يجعل الأتمتة والذكاء الاصطناعي من أهم الأدوات التي تساعد على تحسين الإنتاجية وتقليل الوقت المستغرق في المهام التشغيلية.",
        "نعمل مع المؤسسات القطرية على تطوير حلول عملية تتكامل مع الأنظمة الحالية، وتدعم اللغة العربية والإنجليزية، وتوفر بنية تقنية مرنة قابلة للتوسع بما يتناسب مع نمو الأعمال."
      ],
      keyAdvantages: [
        "حلول ذكاء اصطناعي تدعم العربية والإنجليزية بصورة متكاملة",
        "تطوير برمجيات مخصصة تلائم احتياجات المؤسسات في قطر",
        "أتمتة العمليات الإدارية والتشغيلية لرفع الكفاءة",
        "تكامل مع الأنظمة والمنصات المستخدمة داخل المؤسسة",
        "لوحات تحكم وتقارير تفاعلية لدعم اتخاذ القرار",
        "حلول قابلة للتطوير مع نمو الأعمال وتوسعها"
      ],
      servicesTitle: "خدماتنا للشركات والمؤسسات في قطر",
      services: [
        {
          title: "أتمتة العمليات بالذكاء الاصطناعي",
          description: "أتمتة الإجراءات اليومية، وإدارة الطلبات، وسير العمل، والمهام المتكررة، بما يساعد على تحسين الأداء وتقليل الأخطاء."
        },
        {
          title: "حلول التعليم والتدريب",
          description: "تطوير منصات تعليمية وأنظمة لإدارة الطلاب والدورات والعمليات الإدارية للمؤسسات التعليمية ومراكز التدريب."
        },
        {
          title: "التحول الرقمي للجهات الحكومية",
          description: "تصميم بوابات إلكترونية وأنظمة ذكية تساعد الجهات الحكومية على تحسين الخدمات وأتمتة الإجراءات الداخلية."
        },
        {
          title: "أتمتة الخدمات المهنية",
          description: "تطوير حلول لإدارة العملاء، والمشاريع، والتقارير، وسير العمل في شركات الاستشارات، والمحاماة، والمحاسبة، وغيرها من القطاعات المهنية."
        },
        {
          title: "تطوير البرمجيات المخصصة",
          description: "تصميم وتطوير أنظمة أعمال ومنصات رقمية مصممة خصيصاً لتناسب احتياجات المؤسسة وطبيعة عملياتها."
        },
        {
          title: "وكلاء الذكاء الاصطناعي",
          description: "إنشاء مساعدين ذكيين لخدمة العملاء أو دعم الموظفين والإجابة عن الاستفسارات وتنفيذ المهام المتكررة عبر مختلف قنوات التواصل."
        }
      ],
      industriesTitle: "القطاعات التي نخدمها في قطر",
      industries: [
        "الضيافة والسياحة",
        "التعليم والتدريب",
        "البناء والهندسة",
      ...
      useCasesTitle: "كيف تستفيد المؤسسات القطرية من حلولنا؟",
      useCasesIntro: "",
      useCases: [
        {
          title: "01 تحسين تجربة العملاء والضيوف",
          description: "تطوير أنظمة ذكية تساعد المؤسسات على إدارة الحجوزات، وخدمة العملاء، وتخصيص التجربة، مما يرفع مستوى رضا العملاء ويزيد من كفاءة التشغيل."
        },
        {
          title: "02 أتمتة العمليات التعليمية",
          description: "رقمنة عمليات التسجيل، وإدارة الطلاب، والملفات الأكاديمية، والعمليات الإدارية لتقليل الأعمال اليدوية وتحسين كفاءة المؤسسات التعليمية."
        },
        {
          title: "03 إدارة المشاريع",
          description: "إنشاء لوحات تحكم متقدمة لمتابعة المشاريع، والميزانيات، ونسب الإنجاز، بما يمنح فرق الإدارة رؤية واضحة لحالة العمل في الوقت الفعلي."
        },
        {
          title: "04 بوابات رقمية للعملاء",
          description: "تطوير بوابات إلكترونية تتيح للعملاء متابعة الخدمات، والوصول إلى الملفات، والتواصل مع المؤسسة بسهولة وأمان."
        },
        {
          title: "05 أتمتة إدارة الفعاليات",
          description: "تنظيم عمليات الحجز، وإدارة الموردين، وجدولة المهام، ومتابعة تنفيذ الفعاليات عبر منصة موحدة تقلل الجهد الإداري."
        },
        {
          title: "06 إدارة المواعيد الذكية",
          description: "تطوير أنظمة لحجز المواعيد وإرسال التذكيرات الآلية وتقليل حالات عدم الحضور، بما يحسن استغلال الموارد ويرفع جودة الخدمة."
        }
      ],
      ...
      whyRaanzlr: [
        ...
        "شريك تقني يرافقك في جميع مراحل التطوير والنمو"
      ],
      faqTitle: "الأسئلة الشائعة",
      faqs: [
        {
          q: "هل تقدمون خدماتكم للمؤسسات في جميع أنحاء قطر؟",
          a: "نعم، نقدم خدماتنا للشركات والمؤسسات في مختلف أنحاء دولة قطر، سواء عن بُعد أو من خلال الاجتماعات المباشرة عند الحاجة، مع دعم مستمر خلال جميع مراحل المشروع."
        },
        {
          q: "هل تدعم الحلول اللغة العربية والإنجليزية؟",
          a: "بالتأكيد، جميع حلولنا مصممة لتوفير تجربة استخدام متكاملة باللغتين العربية والإنجليزية، مع إمكانية إضافة لغات أخرى حسب احتياجات المشروع."
        },
        {
          q: "هل يمكن دمج الحلول مع الأنظمة الحالية؟",
          a: "نعم، نعمل على تطوير حلول تتكامل مع أنظمة ERP وCRM والمنصات الأخرى المستخدمة داخل المؤسسة لضمان انتقال سلس وتحقيق أقصى استفادة من البنية التقنية الحالية."
        },
        {
          q: "كيف تبدأون تنفيذ المشروع؟",
          a: "نبدأ بتحليل احتياجات المؤسسة وفهم سير العمل الحالي، ثم نقدم خطة تنفيذ واضحة تشمل مراحل المشروع والمدة الزمنية والتكلفة المتوقعة."
        },
        {
          q: "هل يمكن تخصيص الحلول لتناسب طبيعة عملنا؟",
          a: "نعم، جميع الحلول التي نقدمها قابلة للتخصيص بما يتناسب مع متطلبات كل مؤسسة، سواء من ناحية الوظائف أو سير العمل أو التكامل مع الأنظمة الأخرى."
        },
        {
          q: "كم تستغرق مشاريع التطوير؟",
          a: "تعتمد مدة التنفيذ على نطاق المشروع وتعقيده، ويتم تحديد جدول زمني واضح بعد دراسة المتطلبات لضمان تنفيذ المشروع بجودة عالية وفي الوقت المتفق عليه."
        }
      ],
      ctaTitle: "ابدأ رحلة التحول الرقمي لمؤسستك في قطر",
      ctaDescription: "سواء كنت تدير شركة خاصة، أو مؤسسة تعليمية، أو جهة حكومية، تساعدك Raanzlr على تطوير حلول ذكاء اصطناعي وبرمجيات مخصصة ترفع الكفاءة وتحسن جودة الخدمات. تواصل معنا اليوم لاكتشاف الحل المناسب لاحتياجات مؤسستك."
    }
  },
  ...
  // KUWAIT
  {
    ...
    en: {
      ...
      whyTitle: "Why Kuwaiti Companies Are Exploring AI & Automation",
      whyParagraphs: [
        "Kuwait has a mature business environment with established enterprises in finance, logistics, retail, and professional services. Many of these companies rely on processes that were efficient a decade ago but struggle to scale today—manual approvals, spreadsheet-based reporting, and fragmented communication across teams.",
        "Forward-thinking Kuwaiti businesses recognize that automation isn't just about cutting costs—it's about enabling growth. When customer inquiries get instant responses in Arabic or English, when data flows automatically between systems, and when leadership has real-time visibility into operations, companies can move faster and serve customers better.",
        "Our approach focuses on practical value: we identify repetitive tasks that drain time, design automation workflows that actually fit how your team works, and build custom solutions that integrate with the tools you already use—whether that's local banking systems, CRM platforms, or communication channels like WhatsApp."
      ],
      keyAdvantages: [
      ...
      services: [
        {
          title: "AI Automation Solutions",
          description: "Automate repetitive tasks like follow-ups, data entry, approvals, and reporting. Designed for bilingual Kuwaiti workflows."
        },
        {
          title: "Custom Software Development",
          description: "Build internal tools, dashboards, and operational platforms that match how your Kuwaiti business actually operates."
        },
        {
          title: "AI Chatbots & Customer Service",
          description: "Deploy intelligent chatbots on WhatsApp, websites, or apps that handle inquiries in Arabic and English, 24/7."
        },
        {
          title: "Workflow Automation",
          description: "Connect your CRM, ERP, email, WhatsApp, and other tools into unified automated workflows."
        },
        {
          title: "Dashboards & Real-Time Reporting",
          description: "Give your leadership team live visibility into sales, operations, and KPIs without manual report compilation."
        },
        {
          title: "API Integrations",
          description: "Connect local Kuwaiti systems with international platforms like Salesforce, HubSpot, or Stripe."
        }
      ],
      industriesTitle: "Industries We Serve in Kuwait",
      industries: [
      ...
      useCases: [
        {
          title: "Automating Customer Follow-ups for Service Companies",
          description: "Imagine a Kuwaiti service provider that receives dozens of inquiries daily via WhatsApp and website forms. An AI agent could capture these leads instantly, respond with initial information in Arabic or English, and route qualified leads to the right salesperson—reducing response time from hours to seconds."
        },
        {
          title: "Building Real-Time Dashboards for Financial Services",
          description: "Picture a financial services firm compiling weekly reports from multiple systems manually. A custom dashboard could pull data automatically from accounting software, CRM, and transaction systems—displaying live metrics that leadership can access anytime."
        },
        {
          title: "Creating Custom CRM for Retail Chains",
          description: "Consider a retail chain managing customer data, inventory, and sales across multiple locations using spreadsheets. A custom CRM built specifically for their workflow could centralize data, track customer preferences, automate loyalty programs, and generate insights—all with an Arabic interface."
        },
        {
          title: "Connecting Website Forms to Sales Pipelines",
          description: "Think of a real estate agency where website leads are manually copied into a CRM. Automation could capture form submissions, create CRM records automatically, send confirmation messages, and assign leads to agents based on availability or territory."
        },
        {
          title: "Deploying AI Agents for Customer Support",
          description: "Envision a healthcare clinic network overwhelmed with appointment booking calls and WhatsApp messages. An AI agent could handle appointment scheduling, send reminders, answer common questions in Arabic, and escalate complex cases to staff—freeing up the team for patient care."
        },
        {
          title: "Automating Invoice Generation and Approvals",
          description: "Imagine a professional services firm spending hours weekly on invoice creation and approval routing. An automated system could generate invoices based on completed work, route them through the approval chain automatically, and send them to clients—with minimal manual intervention."
        }
      ],
      whyRaanzlrTitle: "Why Kuwaiti Companies Choose Raanzlr",
      whyRaanzlr: [
      ...
      faqs: [
        {
          ...
          a: "Yes, we work entirely remotely with Kuwaiti businesses through video calls, screen shares, and collaborative tools. We're available during Kuwait City business hours for meetings and support, and can visit in person for key milestones when needed."
        },
        {
          q: "Can your AI systems work in Arabic and English?",
          a: "Absolutely. All our solutions support Arabic (with proper right-to-left design) and English. Whether it's a chatbot, dashboard interface, or automated workflow, we build for bilingual operation from the start."
        },
        {
          q: "Do you integrate with local Kuwaiti systems?",
          a: "Yes, we can integrate with Kuwaiti banking APIs, local payment processors, and regional platforms. If you use a specific Kuwaiti system, we can usually connect it with your other tools."
        },
        {
          q: "What's the first step to get started?",
          a: "Book a free discovery call. We'll discuss your current operations, identify automation opportunities, and provide a clear proposal with scope, timeline, and investment. The first conversation has no commitment—it's purely exploratory."
        },
        {
          q: "How long does a typical project take?",
          a: "It depends on complexity. A simple chatbot or workflow automation might take 2-4 weeks. A custom dashboard or CRM typically takes 6-10 weeks. A full platform with multiple integrated features could take 12-16 weeks. We'll provide a detailed timeline after understanding your requirements."
        },
        {
          q: "What if we already have existing systems?",
          a: "That's common and usually not a problem. We specialize in integrations—connecting your existing CRM, ERP, accounting software, or other tools with new automation and AI capabilities. You don't have to replace what's working."
        }
      ],
      ctaTitle: "Ready to Automate Your Business in Kuwait?",
      ctaDescription: "Whether you're in Kuwait City or elsewhere in Kuwait, let's explore how AI and automation can streamline your operations. Book a free consultation with our team."
    },
    ar: {
      name: "الكويت",
      region: "دول الخليج",
      cities: "مدينة الكويت • الأحمدي • حولي • وجميع أنحاء دولة الكويت",
      metaDescription: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في الكويت. نساعد المؤسسات على تسريع التحول الرقمي من خلال حلول ذكية وأتمتة العمليات.",
      keywords: "ذكاء اصطناعي الكويت، تطوير برمجيات الكويت، أتمتة أعمال الكويت، حلول AI الكويت، برمجيات مخصصة الكويت",
      heroTitle: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في الكويت",
      heroDescription: "تساعد Raanzlr الشركات في الكويت على تسريع التحول الرقمي من خلال حلول الذكاء الاصطناعي، وأتمتة العمليات، وتطوير البرمجيات المخصصة. نصمم أنظمة ذكية ترفع كفاءة الأعمال، وتقلل المهام اليدوية، وتساعد المؤسسات على تقديم خدمات أسرع وأكثر جودة، مع إمكانية التكامل مع الأنظمة الحالية.",
      whyTitle: "لماذا تتجه الشركات الكويتية إلى الذكاء الاصطناعي؟",
      whyParagraphs: [
        "يشهد السوق الكويتي اهتماماً متزايداً بتبني حلول الذكاء الاصطناعي وأتمتة العمليات، مع سعي المؤسسات إلى تحسين الكفاءة التشغيلية، وتطوير تجربة العملاء، ومواكبة التحول الرقمي في مختلف القطاعات.",
        "لا تزال العديد من الشركات تعتمد على إجراءات تشغيل يدوية تستهلك الوقت وتحد من القدرة على التوسع. ومن خلال أتمتة العمليات وتطوير الأنظمة الذكية، يمكن تقليل الأعمال المتكررة، وتحسين تدفق البيانات، وتسريع اتخاذ القرار داخل المؤسسة.",
        "في Raanzlr نعمل على تحليل طبيعة عمل كل مؤسسة، ثم نطور حلولاً مخصصة تتوافق مع احتياجاتها الفعلية، مع الحرص على سهولة التكامل مع الأنظمة المستخدمة حالياً وقابلية التوسع مستقبلاً."
      ],
      keyAdvantages: [
        "حلول ذكاء اصطناعي تدعم اللغة العربية والإنجليزية بالكامل",
        "تطوير برمجيات مخصصة تناسب طبيعة الشركات في الكويت",
        "أتمتة العمليات الإدارية والتشغيلية لتوفير الوقت وتقليل الأخطاء",
        "تكامل سلس مع أنظمة ERP وCRM والمنصات المختلفة",
        "لوحات تحكم وتقارير تفاعلية تدعم اتخاذ القرار",
        "حلول مرنة قابلة للتوسع مع نمو الأعمال"
      ],
      servicesTitle: "خدماتنا للشركات في الكويت",
      services: [
        {
          title: "حلول أتمتة الذكاء الاصطناعي",
          description: "أتمتة المهام اليومية، وإدارة الطلبات، والمتابعات، والموافقات، وسير العمل الداخلي لتقليل الجهد اليدوي وتحسين الإنتاجية."
        },
        {
          title: "تطوير البرمجيات المخصصة",
          description: "تصميم وتطوير أنظمة أعمال، ولوحات تحكم، ومنصات تشغيلية تتوافق مع احتياجات المؤسسة وآلية عملها."
        },
        {
          title: "وكلاء الذكاء الاصطناعي لخدمة العملاء",
          description: "تطوير مساعدين ذكيين يعملون عبر الموقع الإلكتروني أو واتساب أو تطبيقات التواصل للإجابة عن استفسارات العملاء على مدار الساعة."
        },
        {
          title: "أتمتة سير العمل",
          description: "ربط الأنظمة المختلفة داخل المؤسسة وأتمتة انتقال البيانات والمهام بين الإدارات لضمان سير العمليات بكفاءة أكبر."
        },
        {
          title: "لوحات التحكم والتقارير",
          description: "إنشاء لوحات معلومات تفاعلية تعرض مؤشرات الأداء والعمليات بصورة مباشرة، وتساعد الإدارة على متابعة الأعمال واتخاذ قرارات مبنية على البيانات."
        },
        {
          title: "تكامل الأنظمة وواجهات API",
          description: "ربط الأنظمة الداخلية مع المنصات الخارجية والخدمات المختلفة لضمان تبادل البيانات بسلاسة وتحسين كفاءة العمليات."
        }
      ],
      industriesTitle: "القطاعات التي نخدمها في الكويت",
      industries: [
      ...
      useCasesTitle: "كيف تستفيد الشركات الكويتية من حلولنا؟",
      useCasesIntro: "",
      useCases: [
        {
          title: "01 أتمتة خدمة العملاء",
          description: "إنشاء وكلاء ذكاء اصطناعي يستقبلون استفسارات العملاء ويردون عليها فوراً عبر الموقع الإلكتروني أو واتساب، مما يرفع سرعة الاستجابة ويحسن تجربة العملاء."
        },
        {
          title: "02 لوحات تحكم للإدارة",
          description: "تطوير لوحات معلومات موحدة تجمع البيانات من مختلف الأنظمة وتعرض مؤشرات الأداء بصورة لحظية، مما يختصر الوقت المستغرق في إعداد التقارير."
        },
        {
          title: "03 تطوير أنظمة CRM مخصصة",
          description: "تصميم أنظمة لإدارة علاقات العملاء تتوافق مع دورة المبيعات وإجراءات العمل داخل المؤسسة، وتساعد على تنظيم البيانات وتحسين المتابعة."
        },
        {
          title: "04 أتمتة إدارة العملاء المحتملين",
          description: "ربط نماذج الموقع الإلكتروني مع أنظمة CRM وأدوات التسويق لتسجيل العملاء المحتملين وتوزيعهم تلقائياً على فرق المبيعات."
        },
        {
          title: "05 مساعدين ذكيين للعمليات",
          description: "تطوير مساعدين يعتمدون على الذكاء الاصطناعي لتنفيذ المهام المتكررة، والإجابة عن الاستفسارات، وتقديم الدعم للعملاء والموظفين."
        },
        {
          title: "06 أتمتة العمليات الإدارية",
          description: "رقمنة عمليات إنشاء الفواتير، وسير الموافقات، والتقارير الدورية، والإشعارات الداخلية لتقليل الوقت والجهد وتحسين كفاءة التشغيل."
        }
      ],
      whyRaanzlrTitle: "لماذا تختار الشركات الكويتية Raanzlr؟",
      whyRaanzlr: [
        "فهم لطبيعة السوق الكويتي واحتياجات المؤسسات المحلية",
        "خبرة في تطوير حلول الذكاء الاصطناعي والبرمجيات المخصصة",
        "دعم كامل للغة العربية والإنجليزية في جميع الأنظمة",
        "تكامل مرن مع الأنظمة والمنصات المستخدمة داخل المؤسسة",
        "التزام بأعلى معايير الجودة وأمن البيانات",
        "شريك تقني يدعمك في جميع مراحل التطوير والنمو"
      ],
      faqTitle: "الأسئلة الشائعة",
      faqs: [
        {
          q: "هل تقدمون خدماتكم للشركات في جميع أنحاء الكويت؟",
          a: "نعم، نقدم خدماتنا للشركات في مختلف مناطق الكويت، سواء عن بُعد أو من خلال الاجتماعات المباشرة عند الحاجة، مع توفير الدعم الفني طوال مراحل تنفيذ المشروع."
        },
        {
          q: "هل تدعم حلولكم اللغة العربية والإنجليزية؟",
          a: "بالتأكيد، جميع الحلول التي نقدمها تدعم اللغتين العربية والإنجليزية بشكل كامل، سواء في واجهات الاستخدام أو التقارير أو وكلاء الذكاء الاصطناعي."
        },
        {
          q: "هل يمكن دمج الحلول مع الأنظمة الحالية؟",
          a: "نعم، نطور حلولاً تتكامل مع أنظمة ERP وCRM والمنصات المختلفة المستخدمة داخل المؤسسة لضمان انتقال سلس وتحقيق أقصى استفادة من البنية التقنية الحالية."
        },
        {
          q: "كيف تبدأون تنفيذ المشروع؟",
          a: "نبدأ بجلسة استشارية لفهم طبيعة أعمالك وتحليل العمليات الحالية، ثم نقدم خطة تنفيذ واضحة تتضمن مراحل المشروع والجدول الزمني والتكلفة."
        },
        {
          q: "هل يمكن تخصيص الحلول لتناسب طبيعة عمل شركتنا؟",
          a: "نعم، جميع حلولنا يتم تصميمها وتطويرها بما يتناسب مع احتياجات كل مؤسسة، مع إمكانية إضافة وظائف أو تكاملات خاصة حسب متطلبات العمل."
        },
        {
          q: "كم تستغرق مشاريع التطوير؟",
          a: "تختلف مدة التنفيذ بحسب حجم المشروع ومتطلباته، ويتم تحديد جدول زمني واضح بعد دراسة الاحتياجات لضمان تنفيذ المشروع بجودة عالية وفي الوقت المحدد."
        }
      ],
      ctaTitle: "ابدأ رحلة التحول الرقمي لشركتك في الكويت",
      ctaDescription: "سواء كنت تدير شركة ناشئة أو مؤسسة قائمة في الكويت، تساعدك Raanzlr على تطوير حلول ذكاء اصطناعي وبرمجيات مخصصة تعزز الكفاءة، وتبسط العمليات، وتدعم نمو أعمالك. تواصل معنا اليوم لاكتشاف الحل الأنسب لاحتياجات شركتك."
    }
  },
  ...
  // BAHRAIN
  {
    ...
    en: {
      ...
      whyTitle: "Why Bahrain Businesses Are Investing in Better Operations",
      whyParagraphs: ["Bahrain's Economic Development Board identifies financial services, ICT, manufacturing, logistics, and tourism among the Kingdom's key economic sectors. For businesses working across these sectors, reliable data flow and responsive customer operations are practical priorities.", "Growth often exposes gaps between customer channels, finance tools, approvals, and operational reporting. A well-designed system can connect the tools already in use, reduce repeat data entry, and give teams a shared view of the work without forcing a wholesale replacement.", "We begin with the process rather than the technology. Together, we map handoffs, data ownership, and decisions, then deliver the smallest useful automation or platform in stages so your team can adopt it with confidence."],
      keyAdvantages: ["Arabic and English product experiences", "Practical workflows for financial and professional services", "Integration-first delivery for existing systems", "Clear roles, audit trails, and operational visibility", "GCC-aware collaboration and support"],
      servicesTitle: "Services for Bahrain Businesses",
      services: [{ title: "AI Workflow Automation", description: "Automate routing, follow-ups, document intake, and recurring internal tasks while keeping people in control of key decisions." }, { title: "Custom Business Software", description: "Build internal portals, operational tools, and customer-facing platforms that fit the way your organisation works." }, { title: "Customer Service AI", description: "Create Arabic and English assistants that answer routine questions, capture requests, and hand complex cases to your team." }, { title: "Data & Reporting Dashboards", description: "Bring approved data from core systems into useful views for managers and operating teams." }, { title: "System Integrations", description: "Connect CRM, finance, communications, and line-of-business tools through dependable API integrations." }, { title: "Process Discovery", description: "Map the current process, prioritise opportunities, and define a practical delivery roadmap before build work begins." }],
      industriesTitle: "Industries We Serve in Bahrain",
      industries: ["Financial Services & Fintech", "ICT & Digital Services", "Logistics & Trade", "Manufacturing", "Professional Services", "Retail & E-commerce", "Healthcare", "Tourism & Hospitality"],
    ...
    ar: {
      name: "البحرين", region: "دول الخليج", cities: "المنامة • المحرق • الرفاع",
      metaDescription: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في البحرين. نساعد شركات الخدمات المالية والتقنية واللوجستيات على بناء عمليات رقمية مترابطة وعملية.",
      keywords: "أتمتة الذكاء الاصطناعي البحرين، تطوير برمجيات المنامة، تقنية مالية البحرين، أتمتة الأعمال البحرين، برمجيات مخصصة الخليج",
      heroTitle: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في البحرين",
      heroDescription: "تجمع البحرين بين قطاع خدمات مالية راسخ وقطاعات نشطة في التقنية واللوجستيات والتصنيع والسياحة. تساعد Raanzlr المؤسسات على تحويل تعقيد التشغيل إلى إجراءات مترابطة وواضحة من خلال الأتمتة والبرمجيات المخصصة المبنية حول فرق العمل.",
      whyTitle: "لماذا تستثمر الشركات البحرينية في تطوير عملياتها؟",
      whyParagraphs: ["تعد الخدمات المالية وتقنية المعلومات والاتصالات والتصنيع واللوجستيات والسياحة من القطاعات المحورية في الاقتصاد البحريني. وتحتاج الشركات العاملة فيها إلى تدفق موثوق للبيانات وعمليات خدمة قادرة على الاستجابة.", "يكشف النمو غالباً فجوات بين قنوات العملاء وأدوات المالية والموافقات والتقارير التشغيلية. ويمكن للنظام المصمم بعناية أن يربط الأدوات المستخدمة، ويقلل إدخال البيانات المتكرر، ويمنح الفرق رؤية مشتركة للعمل دون استبدال الأنظمة دفعة واحدة.", "نبدأ من سير العمل لا من التقنية. نرسم معكم نقاط التسليم وملكية البيانات والقرارات، ثم ننفذ الأتمتة أو المنصة الأكثر فائدة على مراحل تتيح للفريق تبنيها بثقة."],
      keyAdvantages: ["تجارب رقمية بالعربية والإنجليزية", "إجراءات عملية للخدمات المالية والمهنية", "تكاملات تحافظ على قيمة الأنظمة القائمة", "وضوح في الأدوار وسجلات الإجراءات", "تعاون يفهم بيئة الأعمال الخليجية"],
      servicesTitle: "خدماتنا للشركات في البحرين",
      services: [{ title: "أتمتة سير العمل", description: "أتمتة التوجيه والمتابعة واستقبال المستندات والمهام الداخلية المتكررة مع إبقاء القرارات المهمة بيد الفريق." }, { title: "تطوير برمجيات الأعمال", description: "بناء بوابات داخلية وأدوات تشغيل ومنصات للعملاء تلائم طريقة عمل مؤسستك." }, { title: "ذكاء اصطناعي لخدمة العملاء", description: "مساعدون بالعربية والإنجليزية للإجابة عن الأسئلة المتكررة وتسجيل الطلبات وتحويل الحالات المعقدة للفريق." }, { title: "لوحات البيانات والتقارير", description: "جمع بيانات معتمدة من الأنظمة الأساسية في لوحات مفيدة للإدارة وفرق التشغيل." }, { title: "تكامل الأنظمة", description: "ربط أنظمة CRM والمالية والاتصالات وأدوات الأعمال عبر واجهات API موثوقة." }, { title: "اكتشاف العمليات", description: "فهم الإجراءات الحالية وترتيب الأولويات ووضع مسار تنفيذ عملي قبل البدء في التطوير." }],
      ...
      useCasesTitle: "حالات استخدام عملية للفرق في البحرين", useCasesIntro: "أمثلة على دور الأنظمة المترابطة في دعم العمل اليومي:",
      useCases: [{ title: "إجراءات ضم العملاء", description: "جمع المعلومات المطلوبة من خلال بوابة منظمة وتوجيهها للمراجع المناسب مع إطلاع العميل على الخطوة التالية." }, { title: "فرز طلبات الخدمة", description: "تصنيف الطلبات الواردة من البريد والموقع وقنوات التواصل وإنشاء حالة وتعيينها وفق قواعد خدمة متفق عليها." }, { title: "تقارير الإدارة", description: "استبدال إعداد التقارير اليدوي بلوحات تستمد البيانات من مصادر تشغيلية معتمدة وفق جدول واضح." }, { title: "تنسيق مسار المبيعات", description: "ربط نماذج العملاء المحتملين وسجلات CRM وتوزيع المهام وتذكيرات المتابعة حتى لا تضيع الفرص بين الفرق." }, { title: "مسارات اعتماد المستندات", description: "توجيه العقود أو طلبات الشراء أو النماذج الداخلية إلى المعتمدين المناسبين مع متابعة الحالة وحفظ السجل." }, { title: "مساعدو المعرفة", description: "تمكين الموظفين من العثور على إجابات ضمن السياسات والإرشادات المعتمدة مع التصعيد عند عدم وضوح الإجابة." }],
      whyRaanzlrTitle: "لماذا تختار فرق البحرين Raanzlr؟", whyRaanzlr: ["تنفيذ بالعربية والإنجليزية من الاستكشاف إلى الإطلاق", "أنظمة مبنية على واقع التشغيل", "تنفيذ مرحلي يقلل مخاطر التطبيق", "خبرة في تكامل أدوات الأعمال الحديثة", "توثيق وتسليم واضحان للفريق الداخلي", "شراكة عملية تركز على نتائج نافعة"],
      faqTitle: "أسئلة شائعة من عملائنا في البحرين",
      faqs: [{ q: "هل تعملون مع فرق في البحرين عن بعد؟", a: "نعم. ندير الاستكشاف والتصميم والتنفيذ والدعم عن بعد، عبر ورش عمل منظمة ونقاط متابعة منتظمة تناسب ساعات العمل في البحرين." }, { q: "هل يمكنكم بناء واجهات عربية وإنجليزية؟", a: "نعم. نخطط للغة واتجاه الواجهة والمحتوى ورحلات المستخدم منذ البداية، ولا نتعامل مع العربية كترجمة متأخرة." }, { q: "هل يمكن ربط أنظمتنا الحالية؟", a: "في كثير من الحالات نعم. نراجع أولاً واجهات الربط المتاحة وملكية البيانات والقيود التشغيلية، ثم نقترح أسلوب التكامل الأنسب." }, { q: "هل تقدمون استشارات قانونية أو تنظيمية؟", a: "لا. نصمم النظام وفق المتطلبات التي يحددها فريقكم القانوني والامتثال والأمن، وهم الجهة المختصة بهذه القرارات." }, { q: "كيف يبدأ المشروع؟", a: "نبدأ بجلسة استكشاف مركزة لفهم الإجراء والمستخدمين والبيانات ومعايير النجاح قبل اقتراح النطاق والمراحل." }, { q: "هل يمكن البدء بإجراء واحد؟", a: "نعم. تكون الأتمتة أو لوحة التحكم المركزة غالباً أفضل طريقة لاختبار القيمة قبل توسيع المنصة." }],
      ctaTitle: "ابنوا عمليات أكثر ترابطاً في البحرين", ctaDescription: "تحدثوا مع Raanzlr حول مبادرة عملية في الذكاء الاصطناعي أو الأتمتة أو البرمجيات تنطلق من واقع عمل فريقكم في البحرين."
    }
  },
  ...
  // OMAN
  {
    ...
    en: {
      ...
      whyTitle: "Why Omani Organisations Are Modernising Their Operations", whyParagraphs: ["Oman's investment priorities include sectors such as manufacturing, logistics, renewable energy, tourism, ICT, healthcare, and education. These industries depend on coordinated operations across sites, suppliers, customers, and internal teams.", "As organisations diversify, information commonly becomes spread across spreadsheets, messages, and separate applications. Connecting the right systems can make routine work more visible, reduce duplicated effort, and help teams act on current operational information.", "We design for the people who will use the system every day. That means starting with a clear process, respecting existing tools, and delivering changes in manageable phases that support adoption."],
      keyAdvantages: ["Arabic and English user experiences", "Operational systems for diversified sectors", "Integration with current tools and data sources", "Phased delivery shaped around adoption", "Clear reporting for distributed teams"], servicesTitle: "Services for Oman Businesses",
    ...
    ar: {
      name: "عُمان", region: "دول الخليج", cities: "مسقط • صحار • صلالة • الدقم", metaDescription: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في عُمان. ندعم المؤسسات في تحديث عملياتها في قطاعات اللوجستيات والتصنيع والسياحة والتقنية.", keywords: "أتمتة الذكاء الاصطناعي عُمان، تطوير برمجيات مسقط، تقنية رؤية عُمان 2040، أتمتة الأعمال عُمان، برمجيات مخصصة عُمان",
      heroTitle: "حلول الذكاء الاصطناعي وتطوير البرمجيات للشركات في عُمان", heroDescription: "تضع رؤية عُمان 2040 التنويع الاقتصادي والتحول الرقمي في صميم مستقبل السلطنة. تساعد Raanzlr المؤسسات العُمانية على بناء أنظمة عملية لعمليات مترابطة وخدمات أفضل وقرارات مبنية على المعلومات في القطاعات المتنامية.",
      whyTitle: "لماذا تطور المؤسسات العُمانية عملياتها؟", whyParagraphs: ["تشمل أولويات الاستثمار في عُمان قطاعات مثل التصنيع واللوجستيات والطاقة المتجددة والسياحة وتقنية المعلومات والاتصالات والرعاية الصحية والتعليم. وتعتمد هذه القطاعات على تنسيق دقيق بين المواقع والموردين والعملاء والفرق الداخلية.", "مع تنوع الأعمال، تتوزع المعلومات غالباً بين جداول البيانات والرسائل والتطبيقات المنفصلة. يساعد ربط الأنظمة المناسبة على إظهار العمل اليومي بوضوح وتقليل التكرار وتمكين الفرق من التصرف وفق معلومات تشغيلية حديثة.", "نصمم للفرق التي ستستخدم النظام يومياً. لذلك نبدأ بإجراء واضح، ونحترم الأدوات القائمة، وننفذ التغيير على مراحل يمكن تبنيها."],
      keyAdvantages: ["تجارب مستخدم بالعربية والإنجليزية", "أنظمة تشغيلية للقطاعات المتنوعة", "تكامل مع الأدوات ومصادر البيانات الحالية", "تنفيذ مرحلي يدعم التبني", "تقارير واضحة للفرق الموزعة"], servicesTitle: "خدماتنا للشركات في عُمان",
      services: [{ title: "أتمتة العمليات", description: "أتمتة الطلبات والموافقات والإشعارات والتحديثات المتكررة بين فرق التشغيل." }, { title: "منصات مخصصة", description: "بناء بوابات وتطبيقات للعملاء والشركاء والفرق الميدانية أو العمليات الداخلية." }, { title: "مساعدو الخدمة بالذكاء الاصطناعي", description: "مساعدون يعالجون الاستفسارات الروتينية ويوجهون المستخدم إلى الفريق أو الخطوة المناسبة." }, { title: "أنظمة اللوجستيات وسير العمل", description: "تنسيق المهام والمستندات والحالات ونقاط التسليم عبر عمليات الإمداد والخدمة." }, { title: "لوحات البيانات", description: "تحويل البيانات المعتمدة إلى رؤى تشغيلية مفيدة دون تجميع يدوي للتقارير." }, { title: "تكامل الأنظمة وواجهات برمجة التطبيقات (API)", description: "ربط تطبيقات الأعمال الأساسية حتى تنتقل المعلومات مع سير العمل." }],
      ...
      useCasesTitle: "حالات استخدام للمؤسسات العُمانية", useCasesIntro: "نقاط بداية عملية لتحسين التشغيل اليومي:", useCases: [{ title: "بوابة لعمليات الخدمة", description: "منح العملاء والفرق الداخلية مكاناً واحداً لتقديم الطلبات ومتابعة التقدم واستلام التحديثات." }, { title: "تنسيق المهام بين المواقع", description: "توزيع المهام بين المواقع وتتبع إنجازها وإظهار الحالات الاستثنائية للفرق المسؤولة." }, { title: "إجراءات مستندات الموردين", description: "تنظيم استقبال مستندات الموردين ومراجعتها واعتمادها مع وضوح الملكية والحالة." }, { title: "إدارة الزيارات والحجوزات", description: "تنسيق الاستفسارات والحجوزات والتأكيدات والمتابعة لعمليات السياحة أو الخدمات." }, { title: "لوحة أداء تشغيلية", description: "جمع بيانات مختارة من الأنظمة الحالية في رؤية مشتركة لمقاييس تشغيل متفق عليها." }, { title: "مساعد معرفة داخلي", description: "مساعدة الموظفين في العثور على الإجراءات المعتمدة ومعلومات الخدمة مع حفظ مسارات المراجعة والتصعيد." }],
      whyRaanzlrTitle: "لماذا تختار فرق عُمان Raanzlr؟", whyRaanzlr: ["تصميم منتج يبدأ من العربية وتنفيذ مهني بالإنجليزية", "أنظمة تراعي نقاط التسليم والفرق الفعلية", "عمل مرن ينمو مع الأولويات", "التكامل قبل الاستبدال غير الضروري", "توثيق عملي ودعم للتدريب", "تنفيذ يركز على سهولة الاستخدام"], faqTitle: "أسئلة شائعة من عملائنا في عُمان",
      faqs: [{ q: "هل تخدمون مؤسسات في جميع أنحاء عُمان؟", a: "نعم. نعمل عن بعد مع فرق في مسقط ومختلف مناطق عُمان عبر ورش عمل وتخطيط مشترك ومراجعات منتظمة." }, { q: "هل يدعم الحل العربية والإنجليزية؟", a: "نعم. نبني تجارب ثنائية اللغة تراعي اتجاه الواجهة والمحتوى والتصميم المناسبين." }, { q: "هل يمكن العمل مع نظام ERP أو CRM الحالي؟", a: "نقيّم الأنظمة وواجهات الربط المتاحة ومتطلبات البيانات أولاً، ثم نصمم خطة تكامل مناسبة للمشروع." }, { q: "هل تبنون حلولاً لفرق الصناعة واللوجستيات؟", a: "نعم. يمكننا بناء إجراءات تشغيل وبوابات ولوحات بيانات وتكاملات للعمليات التي يحددها فريقكم." }, { q: "ماذا يحدث في مرحلة الاستكشاف؟", a: "نوثق الإجراء الحالي والمستخدمين ومصادر البيانات والقيود والأولويات، ثم نقترح مسار تنفيذ مركزاً." }, { q: "هل يمكن تنفيذ المشروع على مراحل؟", a: "نعم. يتيح التنفيذ المرحلي اختبار قدرة مفيدة مع المستخدمين قبل توسيعها إلى إجراءات أخرى." }], ctaTitle: "طوروا عملياتكم في عُمان بتقنية عملية", ctaDescription: "استكشفوا مبادرة في الذكاء الاصطناعي أو الأتمتة أو البرمجيات المخصصة تمنح فريقكم في عُمان طريقة عمل أوضح وأكثر ترابطاً."
    }
  },
