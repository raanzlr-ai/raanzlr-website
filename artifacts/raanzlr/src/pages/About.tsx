        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <Stagger className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            {t.about.values.map((v, i) => {
              ...
              return (
                <StaggerItem key={i}>
                  <div className="group relative overflow-hidden rounded-2xl border border-foreground/10 bg-foreground/[0.02] p-7 h-full hover:border-cyan-400/30 transition-colors">
                    ...
                    <p className="mt-3 text-sm text-foreground/60 leading-relaxed">{v.desc}</p>
                  </div>
                </StaggerItem>
              );
            })}
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <Reveal>
              ...
              <div className="mt-6 flex items-center gap-3">
                ...
                <a href="https://www.facebook.com/Raanzlr" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                  className="h-8 w-8 rounded-lg border border-foreground/10 bg-foreground/[0.03] flex items-center justify-center text-foreground/40 hover:text-[#1877F2] hover:border-[#1877F2]/40 transition-colors">
                ...
                <a href="https://www.instagram.com/raanzlr.tech" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                  className="h-8 w-8 rounded-lg border border-foreground/10 bg-foreground/[0.03] flex items-center justify-center text-foreground/40 hover:text-[#E4405F] hover:border-[#E4405F]/40 transition-colors">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
                ...
                <a href="https://www.linkedin.com/company/raanzlr" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                  className="h-8 w-8 rounded-lg border border-foreground/10 bg-foreground/[0.03] flex items-center justify-center text-foreground/40 hover:text-[#0A66C2] hover:border-[#0A66C2]/40 transition-colors">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
            ...
            <Reveal delay={0.2}>
              <div className="relative rounded-3xl overflow-hidden border border-foreground/10 aspect-video">
                <img
                  src="/company-700.webp"
                  srcSet="/company-700.webp 700w, /company.webp 1400w"
