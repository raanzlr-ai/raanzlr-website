...
export default function FAQ() {
  ...
  const faqData: Record<string, FAQCat> = useMemo(() => isAr ? {
    services: { title: "الخدمات", questions: [
      { q: "ما هي الخدمات التي تقدمها Raanzlr؟", a: "نبني وكلاء ذكاء اصطناعي وروبوتات محادثة، ونؤتمت العمليات اليدوية، ونطوّر مواقع وتطبيقات جوال، ونربط الأنظمة، ونصمم حلول ذكاء اصطناعي مخصصة حسب بيانات الشركة وطريقة عملها." },
      { q: "هل تدعمون اللغة العربية في مشاريعكم؟", a: "نعم. نبني الحلول بالعربية والإنجليزية والتركية، مع دعم صحيح للكتابة من اليمين وصياغة عربية لا تبدو مترجمة." },
      { q: "ما الفرق بين روبوتات المحادثة العادية ووكلاء الذكاء الاصطناعي؟", a: "روبوت المحادثة التقليدي يجيب وفق قواعد ثابتة. وكيل الذكاء الاصطناعي يفهم السياق، يستخدم معرفة شركتك، ويتخذ إجراءات داخل أنظمتك مثل الحجز أو تحديث بيانات العميل." },
      { q: "هل يمكنكم التكامل مع أنظمتنا الحالية؟", a: "نعم. نربط الحلول مع أنظمة إدارة العملاء، وتخطيط الموارد، وقواعد البيانات، وأدوات الدعم، وأي واجهات برمجية تحتاجها منظومتك." },
    ...
    pricing: { title: "التسعير والميزانية", questions: [
      { q: "كيف تحددون أسعار مشاريعكم؟", a: "نحسب السعر بحسب نطاق العمل، مستوى التعقيد، الجدول الزمني، والتكاملات المطلوبة. بعد المكالمة الأولى تحصل على عرض واضح يشرح ما سنبنيه وما لا يدخل في النطاق." },
      { q: "ما هو متوسط تكلفة مشروع روبوت محادثة ذكي؟", a: "المشروع الأساسي يبدأ غالباً من خمسة آلاف دولار وقد يصل إلى خمسة عشر ألفاً. إذا دخلت تكاملات عميقة مع أنظمة العملاء أو قواعد المعرفة، يرتفع النطاق بحسب حجم العمل." },
      { q: "هل تقدمون خطط دفع شهرية أو اشتراكات؟", a: "نعم. للمشاريع الأكبر نعمل على دفعات مرتبطة بمراحل واضحة، ويمكن إضافة عقد صيانة أو تطوير شهري بعد الإطلاق." },
      { q: "هل هناك تكاليف خفية أو رسوم إضافية؟", a: "لا. نكتب التكاليف في العرض قبل البدء، وأي تغيير في النطاق لا يدخل التنفيذ إلا بعد موافقة واضحة." },
    ...
    process: { title: "العملية والجدول الزمني", questions: [
      { q: "كم من الوقت يستغرق إنجاز مشروع نموذجي؟", a: "روبوت محادثة بسيط يحتاج عادة إلى أسبوعين أو أربعة. موقع متوسط يحتاج شهراً أو شهرين. تطبيق الجوال أو حل الذكاء الاصطناعي المخصص يأخذ وقتاً أطول بحسب البيانات والتكاملات." },
      { q: "كيف تبدو عملية التطوير لديكم؟", a: "نبدأ بفهم المشكلة، ثم نحدد النطاق ونصمم الحل ونبنيه على مراحل قصيرة. بعد ذلك نختبره على حالات واقعية قبل الإطلاق." },
      { q: "هل يمكنني طلب تعديلات أثناء التطوير؟", a: "نعم. نراجع العمل معك في محطات محددة، والتعديلات الصغيرة داخل النطاق جزء من العملية. إذا تغير المطلوب جذرياً، نوضحه قبل التنفيذ." },
      { q: "ماذا يحدث بعد إطلاق المشروع؟", a: "نبقى قريبين بعد الإطلاق لمعالجة الأخطاء التي تظهر في الاستخدام الحقيقي، ثم يمكنك اختيار عقد صيانة أو تطوير شهري إذا احتاج النظام إلى متابعة مستمرة." },
      ...
      { q: "ماذا يحدث إذا تجاوز المشروع الميزانية أو الجدول الزمني؟", a: "نُدقق في التحديد مسبقاً لتفادي ذلك، وهو نادر. لكن حين تتغير الأمور، وتتغير أحياناً، نُخبركم فوراً ونشرح السبب ونقدم خيارات. لا مفاجآت في نهاية الطريق. إذا اتسع النطاق، نتفق كتابةً قبل أن نبني." },
    ]},
    support: { title: "الدعم والتواصل", questions: [
      ...
      { q: "هل تقدمون استشارات مجانية؟", a: "نعم. نخصص مكالمة أولى قصيرة لفهم احتياجك ومناقشة المسار الممكن قبل أي التزام." },
      { q: "في أي مناطق زمنية تعملون؟", a: "مقرنا في نيوجيرسي (EST/EDT)، ولدينا فرق في الشرق الأوسط (GST/AST) وأوروبا (CET/EET)." },
      { q: "ما هي لغات التواصل التي تدعمونها؟", a: "نتحدث العربية والإنجليزية والتركية. يمكن أن تكون الاجتماعات والوثائق باللغة التي تناسب فريقك." },
