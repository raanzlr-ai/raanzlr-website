  ...
  const sections = isAr ? [
    {
      ...
      title: "قبول الشروط",
      content: [
        "باستخدامك لموقع Raanzlr.com أو أي من خدماتنا، فإنك توافق على الالتزام بشروط الخدمة هذه وجميع القوانين المعمول بها.",
        "إذا كنت لا توافق على أي من هذه الشروط، يرجى عدم استخدام موقعنا أو خدماتنا.",
        "نحتفظ بالحق في تعديل هذه الشروط في أي وقت. سيتم نشر أي تغييرات على هذه الصفحة مع تحديث التاريخ. استمرارك في استخدام الموقع بعد التحديثات يعني موافقتك عليها.",
      ],
    },
    {
      icon: Globe,
      title: "وصف الخدمات",
      content: [
        "تقدم Raanzlr خدمات هندسة البرمجيات والذكاء الاصطناعي، بما في ذلك:",
        ...
        "يتم تحديد نطاق كل مشروع وتسليماته وجدوله الزمني في اتفاقية منفصلة أو بيان عمل.",
      ],
    },
    {
      icon: AlertTriangle,
    ...
    },
    {
      ...
      content: [
        ...
        "",
        "ملكية العميل:",
        "بالنسبة للمشاريع المخصصة، يتم تحديد ملكية التسليمات النهائية (الكود، التصاميم، الوثائق) في اتفاقية المشروع أو بيان العمل. بشكل عام:",
    ...
    },
    {
      ...
      content: [
        "هيكل الدفع:",
        "يتم تحديد شروط الدفع في اتفاقية المشروع أو بيان العمل. عادةً ما تتبع المشاريع أحد الهياكل التالية:",
    ...
    },
    {
      ...
      content: [
        ...
        "يتم تقديم خدماتنا كما هي وحسب التوفر. بينما نسعى جاهدين لتقديم عمل عالي الجودة، لا نقدم أي ضمانات صريحة أو ضمنية فيما يتعلق بالدقة أو الموثوقية أو الملاءمة لغرض معين.",
        "",
        "حدود المسؤولية:",
    ...
    },
    {
      ...
      content: [
        ...
        "إذا تبين أن أي حكم من أحكام هذه الشروط غير قابل للتنفيذ أو غير صالح، فسيتم تعديل هذا الحكم وتفسيره لتحقيق أهدافه إلى أقصى حد ممكن، وستظل الأحكام المتبقية سارية المفعول بالكامل.",
      ],
    },
    {
      icon: Mail,
      title: "تواصل معنا",
      content: [
        "إذا كانت لديك أي أسئلة أو استفسارات بشأن شروط الخدمة هذه، يرجى التواصل معنا:",
  ...
  ] : [
    {
      ...
      content: [
        ...
        "We reserve the right to modify these terms at any time. Any changes will be posted on this page with an updated date. Your continued use of the website after changes are posted constitutes your acceptance of the modified terms.",
      ],
    },
    {
      icon: Globe,
      ...
      content: [
        ...
        "The scope, deliverables, and timeline of each project are defined in a separate agreement or Statement of Work.",
      ],
    },
    {
      icon: AlertTriangle,
